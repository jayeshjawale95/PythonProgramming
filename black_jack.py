...
class Hand:
    ...
    def calc_val(self):
        '''
        Calculate the value of the hand, make aces an 11
        if they don't bust the hand
        '''
...
class Deck:
    ...
    def shuffle(self):
        '''
        Shuffle the deck, python actually already
        has a shuffle method in its random lib
        '''
...
def make_bet():
    ...
    while bet == 0:
        ...
        bet_comp = raw_input()
        # Check to make sure the bet is
        # within the remaining amount of chips left.
...
def stand():
    global playing, chip_pool, deck, player_hand, dealer_hand, result, bet
    '''
    This function will now play the dealers hand,
    since stand was chosen '''
